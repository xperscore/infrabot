...
def release():
    ...
    if version != "latest" and not version.startswith("v"):
        return slack_response(
            ...
            "Must be a git version tag or 'latest' or blank.",
        )
    ...
    if project in ["wkpython", "all"]:
        ...
        attachments.append(
            {
                "color": "#149e1d",
                "text": "Triggered promotion for wkpython at version {0}".format(
                    wkpy_result
                ),
            }
        )
    ...
    if project in ["clients", "all"]:
        ...
        attachments.append(
            {
                "color": "#149e1d",
                "text": "Triggered promotion for clients at version {0}".format(
                    client_result
                ),
            }
        )
